...
function Modalscollege() {
  ...
  const [collegeCoursesActive, setCollegeCoursesActive] = useState(true);
  const [careerCoursesActive, setCareerCoursesActive] = useState(false);
